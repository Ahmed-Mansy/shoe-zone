  ...
  return (
    <div id="user-profile" className="container mx-auto py-8">
      ...
      <div className="flex flex-col space-y-4 mb-8">
        <Link
          to="/profile/edit"
          className="btn btn-primary py-2 px-4 text-white bg-blue-600 rounded hover:bg-blue-700">
          Edit Profile
        </Link>
        <Link
          to="/profile/delete"
          className="btn btn-danger py-2 px-4 text-white bg-red-600 rounded hover:bg-red-700">
          Delete Account
        </Link>
      </div>
    </div>
